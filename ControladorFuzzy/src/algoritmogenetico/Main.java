...
public class Main {
    ...
    public static void main(String[] args) {
     ...
     /*   Genetico genetico = new Genetico(5);
        ...
        System.out.println("QUINTO, AVALIACAO - > "+((Individuo)pop.get(4)).getAvaliacao()+" "+((Individuo)pop.get(4)).getAdaptabilidade()+" "+((Individuo)pop.get(4)).getAdaptabilidadeRelativa());
*/
        Genetico genetico = new Genetico(100); //SE EU FOR MUDAR ISSO AQUI, TENHO QUE TOMAR CUIDADO LA NO METODO ALGORITMOGENETICO()
        Individuo individuo = new Individuo();
        individuo = genetico.algoritmoGenetico(500);
        //System.out.println("GENES DO MELHOR INDIVIDUO -> " +individuo.genes.get(0)+" "+individuo.genes.get(1));
    }
